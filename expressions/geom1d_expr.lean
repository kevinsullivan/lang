...
| smul_displacement1d (k : scalar_expr) (d : displacement1d_expr) : displacement1d_expr
...
| f sp tenv_ denv_ (displacement1d_expr.smul_displacement1d s d) := (static_scalar_eval default_scalar_env s)•(static_displacement1d_eval sp tenv_ denv_ d)
