...
| i v e :=
                ...
                else (i.g.sp r)),i.g.fr, i.g.tr, i.g.vec, i.g.pt, i.g.s, i.g.a⟩, i.ms⟩ 
...
| i v e := 
               ⟨i.t,⟨i.g.sp,(λ r,     
                ...
                else (i.g.fr r)),i.g.tr, i.g.vec,i.g.pt, i.g.s, i.g.a⟩, i.ms⟩
...
| i v e := 
               ⟨i.t,⟨i.g.sp,i.g.fr,(λ r,     
                ...
                else (i.g.tr r)), i.g.vec,i.g.pt, i.g.s, i.g.a⟩, i.ms⟩
...
| i v e := 
               ⟨i.t,⟨i.g.sp,i.g.fr,i.g.tr,(λ r,     
                ...
                else (i.g.vec r)),i.g.pt, i.g.s, i.g.a⟩, i.ms⟩
...
| i v e := 
               ⟨i.t,⟨i.g.sp,i.g.fr,i.g.tr,i.g.vec,(λ r,     
                ...
                else (i.g.pt r)), i.g.s, i.g.a⟩, i.ms⟩
...
| i v e := 
               ⟨i.t,⟨i.g.sp,i.g.fr,i.g.tr,i.g.vec,i.g.pt, i.g.s, (λ r,     
                if (angleVarEq v r) 
